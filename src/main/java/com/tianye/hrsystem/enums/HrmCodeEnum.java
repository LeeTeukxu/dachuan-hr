...
public enum HrmCodeEnum implements ResultCode {
    ...
    CAN_T_MODIFY_PROGRESS(6020, "结果确认或终止不能修改进度"),
    ...
    PARENT_DEPT_CANNOT_BE_SELF(6048, "上级组织不能是自己"),
    YOU_HAVE_NO_EMPLOYEES_IN_HUMAN_RESOURCES(6049, "您在人力资源没有员工"),
    ...
    SHIFT_NAME_ALREADY_EXISTS(6053, "%s:班次名称已存在"),
    GROUP_NAME_ALREADY_EXISTS(6054, "%s:考勤组已存在"),
    RULE_NAME_ALREADY_EXISTS(6055, "%s:考勤规则已存在"),
    ATTEND_DEFAULT_CANNOT_BE_DELETED(6056, "%s默认配置不能删除"),
    EMPLOYEE_NO_EXIST(6057, "员工%s不存在!"),
    EMPLOYEE_ACCOUNT_NO_EXIST(6058, "您尚未开通员工端，请先将您本人添加至人力资源-员工管理"),
    ATTEND_USED_CANNOT_BE_DELETED(6059, "%s配置已被使用,不能删除"),
    SHIFT_SET_ILLEGAL(6060, "%s,请按照班次规则进行调整"),
    TEMPLATE_SAVE_PARAM_ERROR(7001, "%s"),
    RESULT_NULL_ERROR(7002, "当前数据已被删除"),
    APPRAISAL_PLAN_SAVE_PARAM_ERROR(7003, "%s"),
    APPRAISAL_PLAN_QUERY_PARAM_ERROR(7004, "%s"),
    APPRAISAL_CONFIRMATION_ERROR(7005, "%s"),
    EMPLOYEE_APPRAISAL_LEVEL_ERROR(7006, "%s"),
    EMPLOYEE_APPEAL_ERROR(7007, "%s"),
    APPRAISAL_PLAN_STATUS_CHANGE_ERROR(7008, "%s"),
    APPRAISAL_PLAN_START_ERROR(7009, "%s"),
    APPRAISAL_PLAN_STAGE_NULL_ERROR(7010, "当前操作阶段不存在"),
    THE_ATTEND_GROUP_ALREADY_HAS_SELECTED_EMPLOYEE(7011, "%s考勤组已存在选择员工"),
    THE_ATTEND_GROUP_ALREADY_HAS_SELECTED_DEPT(7012, "%s考勤组已存在选择部门"),
    THE_ATTEND_GROUP_ALREADY_DEPT_EMPLOYEE_ERROR(7013, "考勤组中员工与部门下员工重复"),
    THE_ATTEND_GROUP_INTERSECTION_ERROR(7014, "%考勤组中部门下包含选择员工"),
    THE_ATTEND_GO_TO_EMPLOYEE_ERROR(7015, "需要先打上班卡后，才能够打下班卡");
