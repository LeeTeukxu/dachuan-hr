...
import com.tianye.hrsystem.common.RangeValidated;
    ...
    public boolean isValid(Object value, ConstraintValidatorContext context) {
        ...
        try {
            ...
            for (int i = 0; i < minFieldName.length; i++) {
                ...
                if(!bol){
                    if ("minSalary".equals(mintField.getName())&& "maxSalary".equals(maxField.getName())){
                        context.disableDefaultConstraintViolation();
                        context.buildConstraintViolationWithTemplate("最小薪资要小于最大薪资")
                                .addConstraintViolation();
                    }else if("minAge".equals(mintField.getName())&&"maxAge".equals(maxField.getName())){
                        context.disableDefaultConstraintViolation();
                        context.buildConstraintViolationWithTemplate("最小年龄要小于最大年龄")
                                .addConstraintViolation();
                    }
                }
            }
