...
public enum EmployeeContractType {
     ...
     */
    FIXED_TERM_LABOR_CONTRACT(1, "固定期限劳动合同"), NO_FIXED_TERM_LABOR_CONTRACT(2, "无固定期限劳动合同"), WORK_TASK_LABOR_CONTRACT(3, "已完成一定工作任务为期限的劳动合同"), INTERNSHIP_AGREEMENT(4, "实习协议"), LABOR_CONTRACT(5, "劳务合同"), REEMPLOYMENT_AGREEMENT(6, "返聘协议"), LABOR_DISPATCH_CONTRACT(7, "劳务派遣合同"), SECONDMENT_CONTRACT(8, "借调合同"), OTHER(9, "其他");
