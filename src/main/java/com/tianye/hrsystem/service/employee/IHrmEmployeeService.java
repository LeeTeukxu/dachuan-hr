...
public interface IHrmEmployeeService extends BaseService<HrmEmployee> {
    ...
    List<HrmEmployee> listByIds(List<Long> employeeIds);
    /**
     * 新建员工
     *
     * @param employeeVO
     ...
     * @return
     */
    HrmEmployee queryByJobNumber(String jobNumber);

    void ImportDatas(List<EmployeeImportVO> Datas) throws Exception;
