...
public interface IHrmAttendanceClockService extends BaseService<HrmAttendanceClock> {
     ...
     * @param attendanceClock
     */
    void setHrmAttendanceClock(SetHrmAttendanceClockBO attendanceClock);
...
//    void downloadExcel(HttpServletResponse response);
     ...
     * @return
     */
    Map<String, Map<String, Object>> queryAttendanceEmpRecordDetailByDate(List<HrmAttendanceClock> startEmployeeClockList, List<HrmAttendanceClock> endEmployeeClockList, List<String> dates, Long employeeId);
