...
import com.tianye.hrsystem.modules.salary.entity.TaxEntity;
...
public class SalaryAbstractTaxRuleStrategy extends AbstractTaxRuleStrategy {
    ...
    /** @deprecated 已由 {@link TaxCalculator} 替代，保留仅供旧代码兼容 */
    @Deprecated
    ...
    public List<HrmSalaryMonthOptionValue> computeSalary(HrmSalaryMonthEmpRecord salaryMonthEmpRecord, HrmSalaryTaxRule taxRule,
        ...
        BigDecimal cumulativeTaxPayable = TaxCalculator.calculateCumulativeTax(cumulativeTaxableIncome);
