...
import com.tianye.hrsystem.modules.salary.vo.ChangeSalaryRecordVO;
...
@Getter
@Setter
public class SetChangeSalaryRecordDto {
    ...
    public String toString() {
        return "SetChangeSalaryRecordBO{" +
                "employeeId=" + employeeId +
                ", proSalary=" + proSalary +
                ", proBeforeSum='" + proBeforeSum + '\'' +
                ", proAfterSum='" + proAfterSum + '\'' +
                ", salary=" + salary +
                ", beforeSum='" + beforeSum + '\'' +
                ", afterSum='" + afterSum + '\'' +
                ", remarks='" + remarks + '\'' +
