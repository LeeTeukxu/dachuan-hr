...
import com.tianye.hrsystem.enums.ClockOperType;
import com.tianye.hrsystem.enums.ClockStatusEnum;
import com.tianye.hrsystem.enums.ClockType;
...
//    private HrmUploadExcelService excelService;
    ...
    @PostMapping("/add")
    @ApiOperation("添加打卡")
    public Result add(@RequestBody SetHrmAttendanceClockBO attendanceClock) {
    ...
    @PostMapping("/update")
    @ApiOperation("修改打卡")
    public Result update(@RequestBody SetHrmAttendanceClockBO attendanceClock) {
        attendanceClockService.setHrmAttendanceClock(attendanceClock);
        return Result.ok();
    }
