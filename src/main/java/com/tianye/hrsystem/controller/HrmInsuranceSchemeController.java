...
//    public Result<Object> queryInsuranceType(@RequestBody QueryInsuranceTypeBO queryInsuranceTypeBO) {
//        return Result.ok(insuranceSchemeService.queryInsuranceType(queryInsuranceTypeBO));
//    }
//
