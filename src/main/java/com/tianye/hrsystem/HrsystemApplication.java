...
import com.tianye.hrsystem.common.aliyunMessage;
import com.tianye.hrsystem.util.BaseUtil;
...
@MapperScan("com.tianye.hrsystem.**.mapper")
@EnableJpaRepositories(basePackages = "com.tianye.hrsystem.repository")
@PropertySource(value = { "classpath:application.properties" }, encoding = "UTF-8")
@EnableScheduling
public class HrsystemApplication{

    public static void main(String[] args) {
//        String salaryContent = "测试工资明细短息";
//        try {
//            SMSUtils.sendSms("17377700674", salaryContent, 2024, 04, "蒋永铭", Long.valueOf("0001"));
//        }catch (Exception ax) {
//            ax.printStackTrace();
//        }
//        aliyunSmsUp();
...
//    private static void aliyunSmsUp() {
...
//        String queueName="Alicom-Queue-1308305914891741-SmsUp";//在云通信页面开通相应业务消息后，就能在页面上获得对应的queueName,格式类似Alicom-Queue-xxxxxx-SmsReport
//
//        try {
//            puller.startReceiveMsg(accessKeyId, accessKeySecret, messageType, queueName, new aliyunMessage.MyMessageListener());
//        }catch (Exception ax) {
//            ax.printStackTrace();
//        }
//
