...
import com.tianye.hrsystem.imple.AbstractHrmActionRecordService;
...
public class EmployeeActionRecordServiceImpl extends AbstractHrmActionRecordService {
     ...
     * @param oldFieldList
     */
    public Content employeeNOFixedFieldRecord(List<UpdateInformationBO.InformationFieldBO> newFieldList,
            List<HrmModelFiledVO> oldFieldList, Long employeeId) {
        HrmEmployee employee = employeeService.getById(employeeId);
        textList.clear();
