...
import com.tianye.hrsystem.modules.salary.mapper.HrmConfigMapper;
...
//    private IAdminMessageService adminMessageService;
    ...
    public void initAttendData() {
        ...
        hrmAttendanceShift.setCreateTime(LocalDateTime.now());
        ...
        attendanceGroup.setCreateTime(LocalDateTime.now());
        ...
        Long userId= CompanyContext.get().getUserIdValueL();
        //设置考勤班次
        updateAttendGroup(restId, userId, attendanceGroupId, singleShiftId);
    }
