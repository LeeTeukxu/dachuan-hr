...
import com.tianye.hrsystem.common.UploadProperties;
import com.tianye.hrsystem.common.UploadType;
...
public class LocalFileServiceImpl implements FileService {
    ...
    private  UploadProperties getNewOne(){
        UploadProperties pro=new UploadProperties();
        pro.setBucketName("C:/hrmFile");
        pro.setDomain("commonFile/download");
        return pro;
    }
    /**
     * 上传临时文件，和正式上传不同的是，此文件7天后会被删除
    ...
    public FileService build(UploadProperties properties) {
        ...
        if(this.properties==null)this.properties=getNewOne();
