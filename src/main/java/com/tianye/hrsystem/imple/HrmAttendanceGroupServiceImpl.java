...
import com.tianye.hrsystem.common.TagUtil;
...
import com.tianye.hrsystem.mapper.HrmAttendanceGroupMapper;
...
public class HrmAttendanceGroupServiceImpl extends BaseServiceImpl<HrmAttendanceGroupMapper, HrmAttendanceGroup> implements IHrmAttendanceGroupService {
    ...
    public HrmAttendanceGroup queryAttendanceGroup(Long employeeId) {
        HrmEmployee employee = BeanUtils.Clone(employeeService.getById(employeeId),HrmEmployee.class);
     ...
     */
    @Override
    public HrmAttendanceGroup queryAttendanceGroupDingDing(Long employeeId)
    {
        return attendanceGroupMapper.getEmployeeAttendanceGroupDingding(employeeId);
    }

    @Override
    public Set<Long> queryEmployeeIdsInAttendanceGroupDingDing(Collection<Long> employeeIds) {
        if (CollUtil.isEmpty(employeeIds)) {
            return Collections.emptySet();
        }
        List<Long> result = attendanceGroupMapper.queryEmployeeIdsInAttendanceGroupDingding(employeeIds);
