...
public class HrmModelFiledVO {
    ...
    public HrmModelFiledVO() {
    }

    public HrmModelFiledVO(String fieldName, String name) {
        this.fieldName = StrUtil.toCamelCase(fieldName);
        this.name = name;
    }

    public HrmModelFiledVO(String fieldName, FieldEnum fieldEnum) {
        this.fieldName = StrUtil.toCamelCase(fieldName);
        this.type = fieldEnum.getType();
        this.formType = fieldEnum.getFormType();
    }

    public HrmModelFiledVO(String fieldName, FieldEnum fieldEnum, Integer fieldType) {
        this.fieldName = StrUtil.toCamelCase(fieldName);
        this.type = fieldEnum.getType();
        this.formType = fieldEnum.getFormType();
    ...
    public HrmModelFiledVO(String fieldName, FieldEnum fieldEnum, String name, Integer fieldType) {
        this.fieldName = StrUtil.toCamelCase(fieldName);
        this.type = fieldEnum.getType();
        this.formType = fieldEnum.getFormType();
        this.name = name;
    ...
    public HrmModelFiledVO(String fieldName, String name, FieldEnum type, Integer fieldType) {
        this.fieldName = fieldName;
        this.name = name;
        this.type = type.getType();
        this.fieldType = fieldType;
        this.formType = type.getFormType();
    }
    ...
    @ApiModelProperty(value = "标签 1 个人信息 2 岗位信息 3 合同 4 工资社保  5绩效考核")
    ...
    public HrmModelFiledVO setFieldName(String fieldName) {
        this.fieldName = StrUtil.toCamelCase(fieldName);
        return this;
    }

    public HrmModelFiledVO setOriginFieldName(String fieldName) {
        this.fieldName = fieldName;
        return this;
    }
}
