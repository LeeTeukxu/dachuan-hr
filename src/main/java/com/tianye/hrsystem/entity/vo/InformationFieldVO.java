...
public class InformationFieldVO {
    ...
    public String toString() {
        return "InformationFieldVO{" +
                ...
                ", stylePercent=" + stylePercent +
                ", precisions=" + precisions +
                ", formPosition='" + formPosition + '\'' +
                ", maxNumRestrict='" + maxNumRestrict + '\'' +
                ", minNumRestrict='" + minNumRestrict + '\'' +
                ", formAssistId=" + formAssistId +
                ", formType='" + formType + '\'' +
                ", setting=" + setting +
                ", xAxis=" + xAxis +
                ", yAxis=" + yAxis +
                ", optionsData=" + optionsData +
                ", fieldExtendList=" + fieldExtendList +
                ", remark='" + remark + '\'' +
                '}';
    }
}
