...
@TableName("hrm_attendance_history_shift")
@ApiModel(value = "HrmAttendanceHistoryShift对象", description = "历史班次表")
public class HrmAttendanceHistoryShift implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "历史班次id")
    @TableId(value = "shift_history_id", type = IdType.ASSIGN_ID)
    @JsonSerialize(using = ToStringSerializer.class)
    private Long shiftHistoryId;
