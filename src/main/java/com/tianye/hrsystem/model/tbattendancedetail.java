...
@Entity
@Table(name = "tbattendancedetail")
public class tbattendancedetail implements Serializable {
  @Id
	/**
	 * 接口主键
	 */
  ...
  private Date workDate;
	/**
	 * 打卡来源(ATM：考勤机打卡（指纹/人脸打卡）,BEACON：IBeacon,DING_ATM：钉钉考勤机（考勤机蓝牙打卡）,USER：用户打卡,BOSS：老板改签,APPROVE：审批系统,SYSTEM：考勤系统,AUTO_CHECK：自动打卡)
	 */
