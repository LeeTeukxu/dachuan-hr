...
@Entity
@Table(name = "hrm_attendance_history_shift")
public class HrmAttendanceHistoryShift implements Serializable {
  ...
  @GeneratedValue(strategy=GenerationType.IDENTITY)
	 ...
	 * 历史班次id
	 */
  @Column(name = "shift_history_id")
  private Integer shiftHistoryId;
	/**
	 * 班次id
	 */
  ...
  public Integer getShiftHistoryId() {
    return shiftHistoryId;
  }
  public void setShiftHistoryId(Integer shiftHistoryId) {
